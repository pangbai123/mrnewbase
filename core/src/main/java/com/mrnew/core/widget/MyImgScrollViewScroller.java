 ...
 */
class MyImgScrollViewScroller extends Scroller {
    Context context;
    private int mDuration = 500;

    public MyImgScrollViewScroller(Context context) {
        super(context);
        this.context = context;
    }

    public MyImgScrollViewScroller(Context context, Interpolator interpolator) {
