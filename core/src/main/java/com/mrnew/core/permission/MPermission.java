package com.mrnew.core.permission;
...
public class MPermission {
    ...
    private static List<String> getDeniedPermissions(Object activity, String[] permissions) {
        ...
        return MPermissionUtil.findDeniedPermissions(MPermissionUtil.getActivity(activity), permissions);
    }
    ...
    private static List<String> getNeverAskAgainPermissions(Object activity, String[] permissions) {
        ...
        return MPermissionUtil.findNeverAskAgainPermissions(MPermissionUtil.getActivity(activity), permissions);
    }
    ...
    private static List<String> getDeniedPermissionsWithoutNeverAskAgain(Object activity, String[] permissions) {
        ...
        return MPermissionUtil.findDeniedPermissionWithoutNeverAskAgain(MPermissionUtil.getActivity(activity), permissions);
    }
    ...
    private static void requestPermissions(Object object, int requestCode, String[] permissions) {
        ...
        List<String> deniedPermissions = MPermissionUtil.findDeniedPermissions(MPermissionUtil.getActivity(object), permissions);
    ...
    private static void requestResult(Object obj, int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (deniedPermissions.size() > 0) {
            if (MPermissionUtil.hasNeverAskAgainPermission(MPermissionUtil.getActivity(obj), deniedPermissions)) {
